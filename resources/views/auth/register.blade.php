...
<div class="min-h-screen flex items-center justify-center bg-gray-50 p-4">
    <div class="w-full max-w-4xl bg-white rounded-xl shadow-lg overflow-hidden flex flex-col md:flex-row">
        ...
        <div class="md:w-1/2 bg-gradient-to-br from-purple-500 via-pink-500 to-yellow-500 p-8 text-white">
            ...
            <h2 class="text-2xl font-bold mb-4">Join our employee feedback platform</h2>
            <p class="opacity-90 mb-6 text-sm">
                Create your account to start measuring and improving team engagement.
            </p>
            ...
            <div class="space-y-3 text-sm">
                <div class="flex items-start">
                    ...
                    <p class="ml-2 opacity-90">Real-time pulse surveys</p>
                </div>
                <div class="flex items-start">
                    <svg class="flex-shrink-0 h-4 w-4 mt-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    <p class="ml-2 opacity-90">Anonymous feedback options</p>
                </div>
                <div class="flex items-start">
                    <svg class="flex-shrink-0 h-4 w-4 mt-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    <p class="ml-2 opacity-90">Actionable insights dashboard</p>
                </div>
            </div>
        </div>
        ...
        <div class="md:w-1/2 p-8">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600 text-sm mt-1">Get started with PulseSurvey</p>
            </div>
